...
const SearchComponent = ({
    ...
    const onSearch = () => {
        const searchUser = modifiedUserList.find(user => user.name.toLowerCase() == searchName.toLowerCase())
        if (searchUser) {
    ...
    return (
        <View style={styles.container}>
            <View style={styles.searchInputCtn}>
                <Image source={require('../../assets/icons/search.png')} style={styles.searchImg} />
                <TextInput
            ...
            <ModalComponent visible={modalVisible} onClose={() => {
